...
@Component({
  selector: 'app-generate-cheque-challan',
  templateUrl: './generate-cheque-challan.component.html',
  styleUrls: ['./generate-cheque-challan.component.scss']
})

export class GenerateChequeChallanComponent implements OnInit {
