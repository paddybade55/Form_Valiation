...
// const url = '/generate-cash-challan';
@Component({
  selector: 'app-generate-cash-challan',
  templateUrl: './generate-cash-challan.component.html',
  styleUrls: ['./generate-cash-challan.component.scss']
})
export class GenerateCashChallanComponent implements OnInit{
  ...
  public download(): void {
    var blob = new Blob(['/generate-cash-challan'], { type: 'application/pdf' });
    var file =  new File([blob], 'Cash Challan.pdf', { type: 'application/pdf' });
    saveAs(file)
  }
}
